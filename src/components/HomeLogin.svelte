...
<div class="flex justify-center mt-4">
        <button on:click={() => (colorChip = 'blue')}><img src="images/blue-chip.png" alt="Chip 1" /></button>
        <button on:click={() => (colorChip = 'green')}><img src="images/green-chip.png" alt="Chip 2" /></button>
        <button on:click={() => (colorChip = 'orange')}><img src="images/orange-chip.png" alt="Chip 3" /></button>
        <button on:click={() => (colorChip = 'purple')}><img src="images/purple-chip.png" alt="Chip 4" /></button>
        <button on:click={() => (colorChip = 'red')}><img src="images/red-chip.png" alt="Chip 5" /></button>
        <button on:click={() => (colorChip = 'yellow')}><img src="images/yellow-chip.png" alt="Chip 6" /></button>
</div>
